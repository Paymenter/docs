...
sed -i "s|\"Paymenter\"|\"Paymenter $name\"|g" versions/$name/index.md
...
truncate -s-1 .vitepress/sidebars/versioned/default.json
...
echo "This script still needs a bit of work. The .vitepress/sidebars/versioned/default.json may need a bit of tweaking before it works again."
